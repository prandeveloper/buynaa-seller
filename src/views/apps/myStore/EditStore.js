    ...
    axiosConfig
      ...
      .then((response) => {
        ...
        this.setState({
          ...
          openingTym: response.data.data.openingTym,
          closingTym: response.data.data.closingTym,
          ...
          business_type: response.data.data.business_type.value,
          pan_no: response.data.data.pan_no,
          company_panno: response.data.data.company_panno,
          address_proof: response.data.data.address_proof.value,
