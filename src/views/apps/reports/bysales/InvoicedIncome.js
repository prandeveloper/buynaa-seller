...
//               <span>{params.data.Totalincome}</span>
//             </div>
//           );
//         },
//       },
...
export class InvoicedIncome extends Component {
  constructor(props) {
    super(props);
      ...
      <div>
        ...
        <Row>
          <Col lg="4" md="4" sm="6">
            <Card>
              <CardHeader>
                <CardTitle tag="h4">Total Income</CardTitle>
              </CardHeader>
              <CardBody>
                <h5>{this.state.income.Totalincome}</h5>
              </CardBody>
            </Card>
          </Col>
        </Row>
